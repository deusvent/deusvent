...
void * uniffi_logic_fn_constructor_decayqueryserializer_new(RustBuffer data, RustCallStatus *out_status);
...
RustBuffer uniffi_logic_fn_method_decayqueryserializer_serialize(void * ptr, void * public_key, void * private_key, RustCallStatus *out_status);
...
RustBuffer uniffi_logic_fn_method_decayserializer_serialize(void * ptr, RustCallStatus *out_status);
...
void * uniffi_logic_fn_constructor_identityserializer_new(RustBuffer data, RustCallStatus *out_status);
...
RustBuffer uniffi_logic_fn_method_identityserializer_serialize(void * ptr, void * public_key, void * private_key, RustCallStatus *out_status);
