...
void uniffi_logic_fn_free_ping2(void * ptr, RustCallStatus *out_status);
void * uniffi_logic_fn_constructor_ping2_new(RustCallStatus *out_status);
RustBuffer uniffi_logic_fn_method_ping2_serialize(void * ptr, uint8_t request_id, RustCallStatus *out_status);
...
void uniffi_logic_fn_free_serializable(void * ptr, RustCallStatus *out_status);
RustBuffer uniffi_logic_fn_method_serializable_serialize(void * ptr, uint8_t request_id, RustCallStatus *out_status);
...
RustBuffer uniffi_logic_fn_func_serialize_me(void * msg, uint8_t request_id, RustCallStatus *out_status);
...
uint16_t uniffi_logic_checksum_func_serialize_me();
...
uint16_t uniffi_logic_checksum_method_ping2_serialize();
...
uint16_t uniffi_logic_checksum_method_serializable_serialize();
...
uint16_t uniffi_logic_checksum_constructor_ping2_new();
